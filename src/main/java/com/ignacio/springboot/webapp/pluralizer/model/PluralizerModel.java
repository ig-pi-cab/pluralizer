package com.ignacio.springboot.webapp.pluralizer.model;
...
public class PluralizerModel {
    ...
    public void setPalabrasPluralizadas(String[] palabraPluralizadas){
        this.palabrasPluralizadas = palabraPluralizadas;
    }
